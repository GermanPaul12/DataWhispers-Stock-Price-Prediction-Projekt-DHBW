...
def main():
  ...
  cols = st.columns(3)
  with cols[0]:
    st.markdown(create_pricing_card("fa fa-star", "Basic", "0€/Monat", "<li style=list-style-type:check>Aktienanalyse</li><li style=list-style-type:check>Dynamische Dax 40</li><li style=list-style-type:check>24/7 Support</li><br>", "Kostenlos starten"),unsafe_allow_html=True)
  with cols[1]:
    st.markdown(create_pricing_card("fa fa-certificate", "Premium", "25€/Monat", "<li style=list-style-type:check>Individuelle Vermögensberatung</li><li style=list-style-type:check>Premiumuser Dashboard</li><li style=list-style-type:check>Priorisierte Supportanfragen</li><br>", "Jetzt kaufen"),unsafe_allow_html=True)
  with cols[2]:
