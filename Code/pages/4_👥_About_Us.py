...
st.image(HQ_IMG)
st.write("""
        DataWhispers, a renowned company specializing in consulting and stock price prediction, has its headquarters as a testament to modern architectural brilliance and technological advancement. Constructed just two years ago, the building embodies the cutting-edge ethos of the company.
